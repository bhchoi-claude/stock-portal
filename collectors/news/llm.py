...
- **두 글자 미만은 뽑지 않는다.** 한 글자는 다른 낱말 안에 걸려 못 쓴다
- 어느 글에나 나오는 일반어는 뽑지 않는다
  (실적, 매출, 목표주가, 수주, 계약, 공급, 투자, 시장, 사업)

넓은 말과 좁은 말이 같이 나오면 **좁은 것만** 뽑는다
- 'AI 반도체 HBM 수요' -> HBM 만 뽑는다. AI 와 반도체는 버린다
- '2차전지 양극재 단가' -> 양극재 만 뽑는다
- 넓은 말만 있고 좁은 말이 없으면 그때는 넓은 말을 뽑는다

왜 그런가
- 이 키워드는 **평소보다 몇 배 나왔는가**로 쓰인다.
  'AI' 처럼 매일 나오는 말은 배수가 안 움직여 쓸모가 없다.
  '폴더블' 처럼 평소 없다가 갑자기 나오는 말이 신호다
